...
const BUNDLE_ID = 'com.fidelcompany.fastlane'; // ios bundle id
const PACKAGE = 'com.fidelcompany.fastlane'; // android package name
const NAME = 'Fastlane'; // app name
const EXPO_ACCOUNT_OWNER = 'fidelkang'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'fastlaneApp'; // app scheme
